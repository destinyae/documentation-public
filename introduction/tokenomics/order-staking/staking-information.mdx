...
- Stakers can optimize their rewards by holding VALOR for as long as possible. Redeeming VALOR translates to realizing past gains from the current protocol treasury and forfeiting future shares to the remaining VALOR holders.
